...
operación en un ciclo básico de vapor. Este involucrará una compresión 
con un rendimiento isentrópico fijo, una transformación isobárica en 
cada intercambiador de calor y una expansión isoentálpica en la válvula 
