...
90\% de instalaciones dependiendo de estas (IRENA 2023) \cite{IRENA2023}.

% Bombas de calor frente a calderas
Sin embargo, hay estudios que afirman que si se sustituyeran los 
sistemas de calefacción por combustibles fósiles a sistemas 
por bomba de calor, se podría reducir considerablemente tanto 
el consumo eléctrico como el impacto medioambiental (Mayer 2024) 
\cite{Meyer_2024}.
...
Como se puede observar en la \autoref{fig:ciclo_basico} este 
...
En la actualidad, solamente el sector de la calefacción en los edificios 
...
dos tercios están asociados a emisiones indirectas (IEA 2022) \cite{IEA2022FutureHeatPumps}.
